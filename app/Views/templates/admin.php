...
<head>
    ...
    <title>Dashboard Admin Badan Pusat Statistik Ogan Ilir</title>
    <meta name="viewport"
    ...
    <link href="<?= base_url(); ?>/vendor/fontawesome-free/css/all.min1.css" rel="stylesheet" type="text/css">
    <link href="<?= base_url(); ?>/icon/assets/Pe-icon-7-stroke.css" rel="stylesheet" type="text/css">
...
<body>
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
        ...
        <div class="app-main">
            <?= $this->include('templates/sidebaru'); ?>
